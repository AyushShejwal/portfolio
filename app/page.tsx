    ...
    <div className="bg-white rounded-2xl p-6 shadow-sm">
      ...
      >
        ...
        <div className="flex-1">
          <h3 className="font-bold text-[#1a2332] text-base">{exp.company}</h3>
...
const ExperienceSection = () => {
  return (
    <section id="experience" className="snap-section relative min-h-screen flex items-center justify-center px-6 md:px-12 bg-[#FDF8F3] py-20">
...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-[#FDF8F3] transition-all duration-500 relative" style={{ filter: isLightOn ? 'none' : 'brightness(0.5)' }}>
      ...
      <div>
        {/* Hero Section */}
        <section className="hero-section relative min-h-screen px-4 md:px-8 py-20 md:py-0 flex flex-col items-center justify-center">
          <div className="max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 items-center">
            {/* Left Content */}
            <div className="space-y-8">
              <h1 className="text-4xl md:text-6xl lg:text-7xl text-[#1a2332] leading-tight min-h-[180px] md:min-h-[220px] lg:min-h-[270px]">
              ...
              <div className="flex gap-4">
                <a href="https://www.linkedin.com/in/ayush2204/" target="_blank" rel="noopener noreferrer" className="text-[#0A66C2] hover:text-[#004182] transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                </a>
                <a href="https://github.com/ayushshejwal" target="_blank" rel="noopener noreferrer" className="text-[#181717] hover:text-[#000000] transition-colors">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="max-w-4xl mx-auto w-full text-center">
            ...
            >
              ...
              <div className="flex gap-6 justify-center">
                <motion.a
                  href="https://www.linkedin.com/in/ayush2204/"
                  target="_blank"
                  rel="noopener noreferrer"
